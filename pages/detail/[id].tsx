...
const Detail = ({postDetails}:IProps) => {
  ...
  return (
    <div className='flex w-full  absolute left-0 top-0 bg-[#0d1117] flex-wrap lg:flex-nowrap'>
      <div className='relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-[#272b32]'>
          <div className='absolute top-28 left-2 lg:left-8 flex gap-6 z-50'>
            <p className='cursor-pointer' onClick={()=>{router.back()}}>
              <MdOutlineCancel className='text-white text-[35px]'/>
            </p>
          </div>
          <div className='relative'>
             <div className='lg:h-[70vh] h-[60vh]'>
               <video
          ...
          <div className='absolute bottom-5 lg:bottom-40 right-5 lg:right-10 cursor-pointer'>
          {isMuted ? (
      ...
      <div className='relative w-[1000px] md:w-[900px] lg:w-[700px]'>
        ...
        <div className='flex gap-3 p-2 cursor-pointer font-semibold rounded'>
          ...
          <div className='mt-2 px-10'>{userProfile && (
            <LikeButton
            likes={post.likes}
